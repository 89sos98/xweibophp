 ...
 * 本站最新开通微博的用户列表
 * @author yaoying
 * @version $Id: component_15.pls.php 17921 2011-08-21 04:49:59Z yaoying $
 *
 */
class component_15_pls extends component_abstract_pls
{
	...
	function run($mod)
	{
		...
		$result = $result['rst'];
		$followedList = $this->_generateFollowedList($result);
		
		
		// 设置缓存
		$content = TPL::module('component/component_'.$mod['component_id'], array('mod'=>$mod, 'userList'=>$result, 'followedList'=>$followedList), false);
