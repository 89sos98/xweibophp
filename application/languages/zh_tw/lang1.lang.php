...
$_LANG['modules__input__inputReqGloalLogin'] = '您需要登入後才可以發布，';
$_LANG['modules__input__inputGoLogin'] = '現在就去登入';
...
$_LANG['modules__searchUser__addFollow'] = '加關注';
...
$_LANG['modules_microlive_live_detail_users_followed'] = '<span class="followed-btn">已關注</span>';
$_LANG['modules_microlive_live_detail_users_addFollower'] = '<a href="#" class="addfollow-btn" rel="e:fl,t:1"><span class="plus">+</span>加關注</a>';
...
///本地私信
$_LANG['modules__localpm/listGroupByUid__totalContact'] = '已有%s個聯系人';
$_LANG['modules__localpm/listGroupByUid__totalPmNum'] = '共%s條私信';
$_LANG['modules__localpm/listGroupByUid__unreadPmNum'] = '未讀%s條，';
$_LANG['modules__localpm/listGroupByUid__sendTo'] = '發給';
$_LANG['modules__localpm/listGroupByUid__markAllReaded'] = '標記全部已讀';
$_LANG['modules__localpm/dialog__backToList'] = '返回所有私信';
$_LANG['modules__localpm/dialog__dialogBetweenMeAndPerson'] = '我和<em>%s</em>的對話';
$_LANG['modules__localpm/dialog__userNotExist'] = '該用戶沒有登入過該站點，私信功能不可用';
$_LANG['modules__localpm/setting__setting'] = '私信設定';
$_LANG['modules__localpm/setting__setWhoCanSend'] = '設定誰可以給我發私信';
$_LANG['modules__localpm/setting__all'] = '所有人<span>(不包括你的黑名單用戶，部分用戶會受到反垃圾系統限制，依然不能給你發送私信)</span>';
$_LANG['modules__localpm/setting__myattention'] = '我關註的人';
...
$_LANG['adapter__load__fileUpload__uploadFileMine'] = '上傳文件MIME類型不允許！ ';
...
$_LANG['common__template__unknownuser'] = '未知用戶';
...
$_LANG['modules__footer__verify'] = '如何認證';
$_LANG['modules__mod_verify__whatis'] = '什麽是認證？';
$_LANG['modules__mod_verify__description'] = '當用戶名旁點亮<img src="%s">圖標，說明%s微博已經驗證了該帳號的真實性。';
$_LANG['modules__mod_verify__howto'] = '如何認證？';
$_LANG['modules__mod_verify__mailto'] = '填寫以下信息並發送郵件到%s提交審核：';
$_LANG['modules__mod_verify__msg'] = '<p>1、你在%s的昵稱</p>	<p>2、個人身份說明介紹</p>	<p>3、希望被認證的頭銜或稱謂。</p>';
$_LANG['modules__mod_verify__admin'] = '管理員';
