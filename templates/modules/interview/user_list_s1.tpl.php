		...
		<ul>
			...
			<li rel="u:<?php echo $aMaster['id']; ?>" >
	         	...
	         	<?php if ( $aMaster['id'] == USER::uid() ) { ?>
	         		<span>&nbsp;</span>
				<?php } else if ( isset($friendList[(string)$aMaster['id']]) ) { ?>
	         		<span class="followed-btn"><?php LO('modules_interview_user_list_s1_followed');?></span>
	         	<?php } else { ?>
	         		<a href="#" class="addfollow-btn" rel="e:fl,t:1" ><span class="plus">+</span><?php LO('modules_interview_user_list_s1_follow');?></a>
	         	<?php } ?>
