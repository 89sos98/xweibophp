<?php
	 ...
	 * 需要传入$users
	 * @author yaoying
	 * @version $Id: mod_fame_list.tpl.php 17582 2011-07-26 06:27:08Z weijiang $
	 */
...
?>
    <div class="column-item" rel="u:<?php echo $row['id'];?>">
        <div class="item-pic">
			...
			<?php } else {?>
			<a class="addfollow-btn"  rel="e:fl,t:1" href="#"><span class="plus">+</span><?php LO('common__template__toFollow');?></a></li>
			<?php }?>
			<?php }?>
        </div>
