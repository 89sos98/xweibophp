...
<div class="user-pic"><input type="checkbox" rel="e:ck" /><a href="<?php echo URL('ta', 'id=' . $user['id']); ?>"><img src="<?php echo $user['profile_image_url']; ?>" alt="<?php LO('modules__userList__profileImageUrl', F('escape', $user['screen_name']));?>" /></a></div>
	<?php if (!in_array($user['id'], $fids)): ?><a class="addfollow-btn" rel="e:fl,t:1" href="#"><span class="plus">+</span><?php LO('common__template__toFollow');?></a><?php else: ?><span class="followed-btn"><?php LO('common__template__followed');?></span><?php endif; ?>
    <div class="user-info">
