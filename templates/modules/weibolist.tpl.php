...
$param = array('list' => $list,
					...
					'show_delete_link' => true,  //是否显示删除微博的link，默认为是
					);
*/
?>
									<?php
									...
									<div class="feed-list <?php if (!in_array($header, array(1,2,3))){echo 'mblog-list';}?>">
										...
										<?php else:?>
											<!-- 微博列表 -->
											<?php TPL::module('feedlist', array('list' => $list, 'header' => $header, 'author' => $author, 'show_delete_link' => (isset($show_delete_link) ? $show_delete_link : true), ));?>
											<!-- end 微博列表 -->
