<?php 
	...
	$curmsg		= in_array($reqRoute, array('index.messages', 'localpm', 'localpm.dialog'));
	$curmsg_link = HAS_DIRECT_MESSAGES ? URL('index.messages') : URL('localpm');
...
<div class="tab-s2">
	...
	<span <?php if($curmsg){echo 'class="current"';}?> ><span><a href="<?php echo ($curmsg)? 'javascript:void(0)' : $curmsg_link;?>"><?php LO('index__message__listTitle'); ?></a></span></span>
