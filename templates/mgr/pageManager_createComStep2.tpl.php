...
*/
	...
	<?php if ( !in_array($component_id, array(16,21)) ) {	// 微博发布框不用设置?>
		<div class="form-row">
             <label class="form-field">标题</label>
            <div class="form-cont">
                 <input class="input-txt w130" type="text" vrel="_f|ne=m:不能为空" warntip="#titleErr" name="data[title]" value="<?php echo V('r:title','')?>"/>
    ...
    <?php 
		...
		<div class="form-row">
            ...
            <div class="form-cont">
                ...
                <div id="topic_idLabel" <?php if($topic_id < 1) {echo " style='display:none;' ";} ?>>
                        ...
                        <p class="input-item">
							<input type="text" class="input-txt w130" name="param[topics][]" />
							<a href="javascript:;" class="icon-add" onclick="addIcs(this);">添加</a>
							<a href="javascript:;" class="icon-add" onclick="addSpeIcs(this);">添加专题</a>
							<!--<input id="hd_speIcs" type="hidden" name="param[tid][]" />-->
						</p>
                        <!--
		...
		确定添加一个微博发布框吗?
		<?php } elseif (in_array($component_id, array(20, 22))) { // 专题介绍?> 
		<div class="form-row">
			<label class="form-field">文字介绍<br />(支持HTML)</label>
            <div class="form-cont">
				<textarea class="input-area w250" name="param[desc]"></textarea>
            </div>
		</div>
		<?php } elseif (21 == $component_id) { // 专题介绍?> 
		<div class="form-row">
			<label class="form-field">话题</label>
            <div class="form-cont">
				<input class="input-txt w200" name="param[topic]"  warntip="#titleErr" vrel="_ft|ft=|ne=m:不能为空" value="请输入话题关键词" />
				<span id="titleErr" class="tips-error hidden"></span>
            </div>
		</div>
		<?php } elseif (23 == $component_id) { // 视频?> 
		<div class="form-row">
			<label class="form-field">视频代码</label>
            <div class="form-cont">
				<textarea class="input-area w250" vrel="_ft|ft" name="param[code]" >输入视频播放HTML代码</textarea>
            </div>
            <div class="form-cont">
