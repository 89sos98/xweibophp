		...
		<div id="main">
			<div class="content-box">
				...
				<div class="ct-mid">
					...
					<div class="form-row">
						<label for=""><span>*</span><?php echo $_LANG['database_setup_type_select'];?>：</label>
						<select name="cover" id="cover" novaild="true">
						<option value="1" selected><?php echo sprintf($_LANG['database_setup_type_select_clean_or_check_upgrade_install'], XWEIBO_UPGRADE_VERS);?></option>
						<option value="2"><?php echo $_LANG['database_setup_type_select_force_reinstall'];?></option>
						<option value="3"><?php echo $_LANG['database_setup_type_select_conflict_check_install'];?></option>				
						</select>
					</div>
					<div class="attach">
						<p><?php echo sprintf($_LANG['install_attention'], XWEIBO_VERSION);?></p>
						<p><?php echo sprintf($_LANG['install_attention_note1'], XWEIBO_UPGRADE_VERS);?></p>
						<p><?php echo $_LANG['install_attention_note2'];?></p>
						<p><?php echo $_LANG['install_attention_note3'];?></p>
					</div>
