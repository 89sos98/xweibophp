...
<!--                    </div>-->
					...
					<div class="form-row">
                        <label class="form-field" for="declare">Logo链接</label>
                        <div class="form-cont">
                        	<label><input type="radio" value="1" <?php if (!(isset($config['logo_link']) && $config['logo_link'] == '2') ){echo 'checked="checked"'; } ?> name="logo_link">微博广场</label>
                        	<label><input type="radio" value="2" <?php if (isset($config['logo_link']) && $config['logo_link'] == '2' ){echo 'checked="checked"'; } ?> name="logo_link">我的首页</label>
                    	</div>
                    </div>
