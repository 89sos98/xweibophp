...
<body class="main-body">
	<div class="path"><p>当前位置：界面管理<span>&gt;</span><a href="<?php echo URL('mgr/page_manager') ?>">页面设置</a><span>&gt;</span><?php echo APP::F('escape', $page['page_name']);?>设置</p></div>
	<div class="main-cont clear">
		<h3 class="title large"><?php echo APP::F('escape', $page['page_name']);?>设置</h3>
		
		<?php if (!$page['native']): ?>
		<div class="title-set">
			<label>修改页面名称：<input type="text" name="new_page_name" id="new_page_name" value="<?php echo APP::F('escape', $page['page_name']);?>" class="input-txt w180" /></label>
