	...
	<div class="bd">
		<ul>
			...
			<li rel="u:<?php echo $item['id'];?>">
				...
				<?php echo isset($friendList[(string)$item['id']]) ? L('modules_microlive_live_detail_users_followed') : L('modules_microlive_live_detail_users_addFollower'); ?>
			</li>
			<?php endforeach;?>
			<?php endif;?>
		</ul>
		...
		<?php foreach ($guest_list as $item):?>
			<li rel="u:<?php echo $item['id'];?>">
				...
				<?php if ( $item['id'] == USER::uid() ) { ?>
         		<span>&nbsp;</span>
				<?php } else if ( isset($friendList[(string)$item['id']]) ) { ?>
	         		<?php LO('modules_microlive_live_detail_users_followed');?>
	         	<?php } else { ?>
	         		<?php LO('modules_microlive_live_detail_users_addFollower');?>
	         	<?php } ?>
			</li>
		<?php endforeach;?>
		<?php endif;?>
