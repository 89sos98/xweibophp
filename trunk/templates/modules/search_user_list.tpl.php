                            ...
                            <li rel="u:<?php echo $item['id'];?>">
                                <div class="list-content">
									...
									<?php if ($item['id'] !== USER::uid()) {?>
										...
										<span class="followed-btn"><?php LO('modules__searchUser__followed');?></span>
                                        <?php } else {?>
										<a href="#" rel="e:fl,t:1" class="addfollow-btn"><span class="plus">+</span><?php LO('modules__searchUser__addFollow');?></a>
                                        <?php }?>
									<?php }?>
                                    </div>
                                    <div class="content-m">
