											...
											<div class="list-content">
												...
												<?php $r = APP::getRequestRoute(1);if ($r['function'] == 'fans') {?>
													<?php if (USER::uid() != $userinfo['id']):?>
														...
														<?php else:?>
														<a href="#" class="addfollow-btn" rel="e:fl,t:1"><span class="plus">+</span><?php LO('common__template__toFollow');?></a>
														<?php endif;?>
													<?php else:?>
														...
														<?php else:?>
														<a rel="e:fl,t:1" class="addfollow-btn" href="#"><span class="plus">+</span><?php LO('common__template__toFollow');?></a>
													<?php endif;?>
														<a href="javascript:;" rel="e:sdm,n:<?php echo F('escape', addslashes($item['screen_name']));?>" id="sendMsg" class="hidden"><?php LO('modules__userList__sendMessage');?></a>
													<?php endif;?>
												...
												<?php } else {?>
													<?php if (USER::uid() != $userinfo['id']):?>
														...
														<span class="followed-btn"><?php LO('common__template__followed');?></span>
														<?php else:?>
														<a class="addfollow-btn"  rel="e:fl,t:1" href="#"><span class="plus">+</span><?php LO('common__template__toFollow');?></a>
														<?php endif;?>
													<?php else:?>
														<?php if (in_array($item['id'], $fids)):?>
														<div class="icon-each-follow" title="<?php LO('modules__userList__haveMutualInterest');?>"></div>
