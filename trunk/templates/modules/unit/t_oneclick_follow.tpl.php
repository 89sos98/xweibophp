					...
					<li>
						...
						<p><?php 
							if(isset($userinfo['description'])){
								$userinfo['description'] = mb_strlen($userinfo['description'],'UTF-8')>13?mb_substr($userinfo['description'],0,13,'UTF-8').'...':$userinfo['description'];
								echo APP::F('escape', $userinfo['description']);
							}
							?></p>
					</li>
					<?php
